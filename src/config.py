...
""",
      ...
      "per_LLM_configs": [
        ...
        # OpenAIConfig(**{"model_name": "gpt-6-sol", "threads": 3, "min_throttle_time": 3.0, "temperature": -1.0, "api_type": "default"}),
...
""",
      ...
      "per_LLM_configs": [ #TODO: Multithreading doesnt support automatic deletion atm, manually delete
        ...
        # MiniMaxAIConfig(**{"model_name": "minimax-m2p7", "temperature": 0.0, "min_throttle_time": 4.0, "api_type": "fireworks"}),
        # AnthropicConfig(**{"model_name": "claude-opus-4-7", "threads": 1, "temperature": 0.0, "api_type": "default"}),
        # DeepSeekAIConfig(**{"model_name": "DeepSeek-V4-Pro", "threads": 4, "temperature": 0.0, "min_throttle_time": 20.0, "api_type": "fireworks"}),
