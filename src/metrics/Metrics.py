...
class Metrics:
    ...
    def compute_hallucination_rate(self, hhem_scores, threshold=0.5):
    ...
    def compute_factual_consistancy_rate(self, hhem_scores, threshold=0.5):
    ...
    def compute_answer_rate(self, summaries):
    ...
    def compute_avg_summary_length(self, summaries):
        summary_lengths = []
