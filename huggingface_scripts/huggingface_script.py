...
model_size_map = {
    ...
    "anthropic/claude-opus-4-7": "large",
    ...
    "deepseek-ai/DeepSeek-V4-Pro": "large",
    ...
    "google/gemma-4-26b-a4b-it": "small",
    "google/gemma-4-31b-it": "small",
    "google/gemini-3-flash-preview": "large",
    "google/gemini-3.1-flash-lite-preview": "large",
    "ibm-granite/granite-4.0-h-small": "small",
    "ibm-granite/granite-3.3-8b-instruct": "small",
    "inceptionlabs/mercury-2": "large",
    ...
    "moonshotai/kimi-k2.6": "large",
    "nvidia/Nemotron-3-Nano-30B-A3B": "small",
    "openai/gpt-5.4-mini": "large",
    "openai/gpt-5.4-nano": "large",
    "openai/gpt-5.4-pro": "large",
    "openai/gpt-5.4": "large",
    "openai/gpt-5.5": "large",
    "openai/gpt-5.6-sol": "large",
    "openai/gpt-6-astra": "large",
    "openai/gpt-6-sol": "large",
    ...
    "qwen/qwen3.5-plus": "large",
    "qwen/qwen3.5-flash": "large",
    "qwen/qwen3.5-35b-a3b": "large",
    "qwen/qwen3.5-122b-a10b": "large",
    "qwen/qwen3.5-27b": "small",
...
accessibility_map = {
    ...
    "anthropic/claude-sonnet-4-6": "commercial",
    ...
    "anthropic/claude-opus-4-7": "commercial",
    ...
    "deepseek-ai/DeepSeek-V4-Pro": "open",
    "google/gemini-2.5-flash": "commercial",
    "google/gemini-3-flash-preview": "commercial",
    "google/gemini-3.1-flash-lite-preview": "commercial",
    ...
    "moonshotai/kimi-k2.6": "open",
    "nvidia/Nemotron-3-Nano-30B-A3B": "open",
    "openai/gpt-5.4-mini": "commercial",
    "openai/gpt-5.4-nano": "commercial",
    "openai/gpt-5.4-pro": "commercial",
    "openai/gpt-5.4": "commercial",
    "openai/gpt-5.5": "commercial",
    "openai/gpt-5.6-sol": "commercial",
    "openai/gpt-6-astra": "commercial",
    "openai/gpt-6-sol": "commercial",
    ...
    "qwen/qwen3.5-plus": "open",
    "qwen/qwen3.5-flash": "commercial", #? In particular, Qwen3.5-Flash is the hosted version corresponding to Qwen3.5-35B-A3B with more production features, e.g., 1M context length by default and official built-in tools. (https://huggingface.co/Qwen/Qwen3.5-35B-A3B)
    "qwen/qwen3.5-35b-a3b": "open",
    "qwen/qwen3.5-122b-a10b": "open",
    "qwen/qwen3.5-27b": "open",
