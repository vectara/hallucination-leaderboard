...
mapping = {
    ...
    # 'mistralai/Mixtral-8x22B-Instruct-v0.1', # On HF, no need to rename
    # 'mistralai/mistral-small-latest', # I cannot determine the version or date code. Mistral-small has v.2, v.3.x.
    # 'mistralai/Mistral-Nemo-Instruct-2407', # On HF, no need to rename
    ...
    # 'mistralai/Mixtral-8x7B-Instruct-v0.1', # On HF, no need to rename
    ...
    # 'mistralai/Mistral-Small-24B-Instruct-2501', # On HF, no need to rename
    # 'mistralai/ministral-3b-latest', # I cannot find this model. There is only ministral-3b-instruct. 
    # 'mistralai/Mistral-7B-Instruct-v0.3', # On HF, no need to rename
